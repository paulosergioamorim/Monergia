...
namespace Monergia.Migrations
{
    ...
    [Migration("20250326154931_RemoveEnderecoTable")]
    partial class RemoveEnderecoTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monergia.Models.VisitaElevador", b =>
                {
                    b.Property<Guid>("VisitaTecnicaId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ElevadorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("VisitaTecnicaId", "ElevadorId");

                    b.HasIndex("ElevadorId");

                    b.ToTable("VisitasElevadores");
                });
            ...
            modelBuilder.Entity("Monergia.Models.VisitaTecnica", b =>
                {
                    ...
                    b.Property<bool>("DevolucaoChave")
                    ...
                    b.Property<bool>("EmpregoMaterial")
                        .HasColumnType("boolean");
                    ...
                    b.Property<TimeSpan>("TempoParalizacao")
            ...
            modelBuilder.Entity("Monergia.Models.VisitaElevador", b =>
                {
                    b.HasOne("Monergia.Models.Elevador", "Elevador")
                        .WithMany()
                        .HasForeignKey("ElevadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Monergia.Models.VisitaTecnica", "VisitaTecnica")
                        .WithMany("ElevadoresVisita")
                        .HasForeignKey("VisitaTecnicaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Elevador");
